            ...
            <article>
                <header class="coment-meta comment-author vcard clearfix">
                    ...
                    <div class="alignright textright">
                        <span class="type"><?php echo ($tipo == 'encaminhamento') ? ucfirst($tipo) : 'Opinião'; ?></span>
                    </di>
                </header>
                ...
                <section class="actions clearfix">
                    ...
                    <div class="bottom alignright">
                        <button class="btn btn-mini btn-success"><?php echo delibera_gerar_curtir($comment->comment_ID, 'comment'); ?></button>
                        <button class="btn btn-mini btn-danger"><?php echo delibera_gerar_discordar($comment->comment_ID, 'comment'); ?></button>                                                
                    </div>
                </section><!-- .reply -->
                <?php
